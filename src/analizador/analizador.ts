import { Token, LexerError } from '../models/token';
...
export class Lexer {
        ...
        while (this.position < this.input.length) {
            ...
            if (/[a-zA-Z]/.test(char)) {
                ...
                for (const key in KEYWORDS) {
                    if (KEYWORDS[key as keyof typeof KEYWORDS] === lexema) {
            ...
            switch (char) {
                case '(': this.addToken(char, TOKEN_TYPES.PARENTESIS_ABRIR, startCol); break;
                case ')': this.addToken(char, TOKEN_TYPES.PARENTESIS_CERRAR, startCol); break;
                case '{': this.addToken(char, TOKEN_TYPES.LLAVE_ABRIR, startCol); break;
                case '}': this.addToken(char, TOKEN_TYPES.LLAVE_CERRAR, startCol); break;
                case '[': this.addToken(char, TOKEN_TYPES.CORCHETE_ABRIR, startCol); break;
                case ']': this.addToken(char, TOKEN_TYPES.CORCHETE_CERRAR, startCol); break;
                case ';': this.addToken(char, TOKEN_TYPES.PUNTO_COMA, startCol); break;
                case ',': this.addToken(char, TOKEN_TYPES.COMA, startCol); break;
                case ':': this.addToken(char, TOKEN_TYPES.DOS_PUNTOS, startCol); break;
                default:
    ...
    private addToken(lexema: string, tipo: string, startCol: number): void {
        this.tokenCount++;
        this.tokens.push({
