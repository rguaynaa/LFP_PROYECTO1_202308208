export class Router {
     ...
     */
    openHtmlInNewTab(htmlContent: string, fileName: string, title: string): Window | null {
     ...
     */
    openErrorReport(errorHtml: string): void {
     ...
     */
    openPensum(pensumHtml: string): void {
        this.openHtmlInNewTab(pensumHtml, 'pensum.html', 'Pensum Interactivo');
    }

    // Puedes añadir más métodos para la navegación si tu UI crece.
}